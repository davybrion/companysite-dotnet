I already tried to explain this <a href="http://davybrion.com/blog/2009/03/must-everything-be-virtual-with-nhibernate/">before</a>, but here's a simple example from a presentation i recently did on NHibernate:  
